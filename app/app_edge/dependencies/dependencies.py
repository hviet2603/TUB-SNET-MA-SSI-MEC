...
async def authenticate_request_with_VPExchange(
    ...
    # Send proof request    
    if connection_type == ApplicationConnectionType.EDGE_TO_EDGE:
    ...
    elif connection_type == ApplicationConnectionType.TWIN_DRONE_TO_EDGE:
    ...
    elif connection_type == ApplicationConnectionType.TWIN_CAR_TO_EDGE:
