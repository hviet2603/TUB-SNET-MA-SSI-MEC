...
from ....env_config import get_agent_config, EDGE_NAME, EDGE_ALPHA_WEB_URL, EDGE_BETA_WEB_URL, AUTHORITY_WEB_URL, CAR_WEB_URL, TWIN_DRONE_WEB_URL
...
async def app_migration():
    try:
        ...
        new_app_info : AppMigrationNewAppInfo = await trigger_application_migration(
            ...
            app_manifest=ApplicationManifestModel(
                ...
                environment={
                    ...
                    "TWIN_DRONE_WEB_URL": TWIN_DRONE_WEB_URL,
                ...
                command=f"uvicorn app.app_digital_twin_car.main:app --host 0.0.0.0 --port {str(web_port)}",              
            )
        )
        ...
        metric_logger.info(f"[App Migration] Change verkey time: {change_verkey_end - change_verkey_start} seconds")
